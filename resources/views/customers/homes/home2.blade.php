...
<div class="container mt-5">
    ...
    <div class="row align-items-center">
        <div class="col-12">
            <div class="position-relative">
                <img src="{{ asset('images/tari-kecak-home.webp') }}" alt="Kostum Terbaru" class="img-fluid rounded" style="width: 100%; height: auto;">
                <div class="position-absolute" style="top: 30%; right: 5%; color: white; text-align: right;">
                    ...
                    <a href="#produk" class="btn btn-dark text-white px-4 py-2 mt-3">Lihat</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="{{ asset('images/tari-kecak-home.webp') }}" class="card-img-top rounded" alt="Gelungan Margapati">
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="{{ asset('images/tari-kecak-home.webp') }}" class="card-img-top rounded" alt="Gelungan Cendrawasih">
                    <div class="card-body">
            ...
            <div class="col-md-4 mb-4">
                <div class="card">
                    <img src="{{ asset('images/tari-kecak-home.webp') }}" class="card-img-top rounded" alt="Badong Tari">
                    <div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-4 d-flex align-items-stretch">
            <div class="card w-100">
                <img src="{{ asset('images/tari-kecak-home.webp') }}" class="card-img-top rounded" alt="Full Set Kostum Tari Kijang" style="height: 100%; object-fit: cover;">
        ...
        <div class="col-md-6">
            <div class="row mb-4">
                <div class="col-12">
                    <div class="card">
                        <img src="{{ asset('images/tari-kecak-home.webp') }}" class="card-img-top rounded" alt="Kipas Tari">
                        <div class="card-body">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <img src="{{ asset('images/tari-kecak-home.webp') }}" class="card-img-top rounded" alt="Stagen Prada/Sabuk Prada Lilit">
                        <div class="card-body">
